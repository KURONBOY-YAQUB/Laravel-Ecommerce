                                                ...
                                                <td>
                                                    <div class="input-group mb-3" style="width: 150px">
                                                        <input type="number" value="{{ $prodColor->quantity }}"
                                                            class="productColorQty form-control form-control-sm">
                                                        <button type="button" value="{{ $prodColor->id }}"
                                                            class="updateProductColorQty btn btn-sm btn-primary text-white">Update</button>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button type="button"
                                                        class="deleteProductColorQty btn btn-sm btn-danger"
                                                        value="{{ $prodColor->id }}">
                                                        Delete
                                                    </button>
                                                </td>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.updateProductColorQty', function() {
            ...
            $(document).on('click', '.deleteProductColorQty', function() {
                var product_color_id = $(this).val();
                var thisClick = $(this);
