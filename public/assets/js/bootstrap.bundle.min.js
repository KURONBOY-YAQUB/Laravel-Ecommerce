...
!(function (t, e) {
        ...
        off(t, e, i, n) {
            ...
            if (void 0 === o) {
                ...
                for (const [i, n] of Object.entries(c)) {
                    const s = i.replace(v, "");
                    (a && !e.includes(s)) ||
                        L(t, l, r, n.callable, n.delegationSelector);
                }
            } else {
    ...
    class Y extends $ {
        ...
        _initEvents() {
            this._supportPointerEvents
                ? (I.on(this._element, "pointerdown.bs.swipe", (t) =>
                      this._start(t)
                  ),
                  I.on(this._element, "pointerup.bs.swipe", (t) =>
                      this._end(t)
                  ),
                  this._element.classList.add("pointer-event"))
                : (I.on(this._element, "touchstart.bs.swipe", (t) =>
                      this._start(t)
                  ),
                  I.on(this._element, "touchmove.bs.swipe", (t) =>
                      this._move(t)
                  ),
                  I.on(this._element, "touchend.bs.swipe", (t) =>
                      this._end(t)
                  ));
        }
    ...
    class rt extends W {
        ...
        _addEventListeners() {
            this._config.keyboard &&
                I.on(this._element, "keydown.bs.carousel", (t) =>
                    this._keydown(t)
                ),
                "hover" === this._config.pause &&
                    (I.on(this._element, "mouseenter.bs.carousel", () =>
                        this.pause()
                    ),
    ...
    class Ti extends $ {
        ...
        activate() {
            this._isActive ||
                ...
                I.off(document, yi),
                I.on(document, "focusin.bs.focustrap", (t) =>
    ...
    class Ii extends W {
        ...
        show(t) {
            this._isShown ||
                ...
                I.trigger(this._element, Oi, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
    ...
    class Bi extends W {
        ...
        hide() {
            this._isShown &&
                (I.trigger(this._element, "hide.bs.offcanvas")
                    .defaultPrevented ||
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
    ...
    const zi = new Set([
        ...
        Vi = (t, e) => {
            ...
            return e.includes(i)
                ? !zi.has(i) ||
                      Boolean(Ri.test(t.nodeValue) || qi.test(t.nodeValue))
    ...
    class ln extends W {
        ...
        _configAfterMerge(t) {
            return (
                (t.container =
                    !1 === t.container ? document.body : s(t.container)),
    ...
    class xn extends W {
        constructor(t) {
            super(t),
                ...
                this._parent &&
                    ...
                    I.on(this._element, "keydown.bs.tab", (t) =>
                        this._keydown(t)
                    ));
        }
        static get NAME() {
        ...
        show() {
            ...
            const e = this._getActiveElem(),
                i = e
                    ? I.trigger(e, "hide.bs.tab", { relatedTarget: t })
                    : null;
            I.trigger(t, "show.bs.tab", { relatedTarget: e })
                .defaultPrevented ||
